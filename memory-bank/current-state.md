...
- [T-106] [ATS-5] GitHub Actions 배포 workflow 실행에 필요한 GitHub Secrets 등록과 첫 수동 실행 검증이 아직 남아 있다.
...
1. [T-106] [ATS-5] GitHub Secrets 설정 후 GitHub Actions 배포 workflow를 수동 실행하고 결과를 확인한다.
